...
namespace Necnat.Abp.NnMgmtBilling.Domains
{
    public interface IBillingClientRepository : IRepository<BillingClient, Guid>
    {
        ...
        Task<List<IdentityUser>> InsertUserAsync(Guid id, Guid userId, bool autosave = false);
        ...
        Task<List<OpenIddictApplication>> InsertOpenIddictApplicationAsync(Guid id, Guid openIddictApplicationId, bool autosave = false);
